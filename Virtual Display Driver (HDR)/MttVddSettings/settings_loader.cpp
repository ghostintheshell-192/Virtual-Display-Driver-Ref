...
void Refactoring::SettingsLoader::OverrideDefaultsRegistry()
{
	...
	reg_reader.GetSetting<bool>(keys({"hdr10_static_metadata", "enabled"}), settings.hdr_advanced.static_metadata_enabled);
	...
	reg_reader.GetSetting<bool>(keys({"color_space", "enabled"}),
